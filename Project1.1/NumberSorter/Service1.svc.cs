...
namespace NumberSorter
{
    ...
    {
        public string InsertionSort(string s, int flag)
        {
            ...
            //David Judkins- insertion sort on array of integers ascending or descending order based off the flag number
            if (flag == 1)
            {
            ...
            //builds the string for return value
